...
@Component
public class ContinuousScrapperAmazonUS{

	private static final Logger logger = LoggerFactory.getLogger(ContinuousScrapperAmazonUS.class);	
	
	
	@Autowired
	private AmazonUSConnector connector;
