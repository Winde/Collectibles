...
public class BackgroundProcessorPrices extends Thread{
	...
	public BackgroundProcessorPrices(Collection<Product> products,ProductRepository productRepository,ImageRepository imageRepository, AuthorRepository authorRepository,  ProductInfoConnector connector){
	...
	private boolean doOne(Product product)throws TooFastConnectionException {
		return product.updatePricesWithConnector(getConnector());
	}
}
